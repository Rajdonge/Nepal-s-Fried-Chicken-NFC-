...
class CreateOrderSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        # If not authenticated (guest), all shipping fields are required
        ...
        # For authenticated users without address_id, validate shipping fields
        if is_authenticated and not address_id:
            required_fields = ['full_name', 'phone', 'address', 'city']
            missing_fields = []
            ...
            if missing_fields:
                raise serializers.ValidationError({
                    'message': f'Please provide shipping information or select a saved address. Missing: {", ".join(missing_fields)}',
                    'missing_fields': missing_fields
                })
...
class AddressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'full_name', 'phone', 'address', 'landmark', 'city', 
...
class CreateAddressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Address
        fields = [
            'address_type', 'full_name', 'phone', 'address', 'landmark',
    ...
    def validate(self, data):
        ...
        # Add this line to get the instance for updates
        instance = getattr(self, 'instance', None)

        # Change this condition to check if creating OR changing to existing type
        ...
        # Add this new condition for updates
